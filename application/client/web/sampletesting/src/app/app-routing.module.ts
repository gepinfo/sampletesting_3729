...
{ path : 'createproducts', loadChildren: () => import('./createproducts/createproducts.module').then(m => m.CreateproductsModule), canActivate: [AuthGuard] } , 
{ path : 'updeleteproducts', loadChildren: () => import('./updeleteproducts/updeleteproducts.module').then(m => m.UpdeleteproductsModule), canActivate: [AuthGuard] } , 
{ path : 'viewproduct', loadChildren: () => import('./viewproduct/viewproduct.module').then(m => m.ViewproductModule), canActivate: [AuthGuard] } , 
];
